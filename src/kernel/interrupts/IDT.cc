...
void IDT::init() {
    ...
    setGate(32, (uint64_t)isr32, 0x08, 0x8E);
    setGate(33, (uint64_t)isr33, 0x08, 0x8E);
    setGate(34, (uint64_t)isr34, 0x08, 0x8E);
    setGate(35, (uint64_t)isr35, 0x08, 0x8E);
    setGate(36, (uint64_t)isr36, 0x08, 0x8E);
    setGate(37, (uint64_t)isr37, 0x08, 0x8E);
    setGate(38, (uint64_t)isr38, 0x08, 0x8E);
    setGate(39, (uint64_t)isr39, 0x08, 0x8E);
    setGate(40, (uint64_t)isr40, 0x08, 0x8E);
    setGate(41, (uint64_t)isr41, 0x08, 0x8E);
    setGate(42, (uint64_t)isr42, 0x08, 0x8E);
    setGate(43, (uint64_t)isr43, 0x08, 0x8E);
    setGate(44, (uint64_t)isr44, 0x08, 0x8E);
    setGate(45, (uint64_t)isr45, 0x08, 0x8E);
    setGate(46, (uint64_t)isr46, 0x08, 0x8E);
    setGate(47, (uint64_t)isr47, 0x08, 0x8E);
    setGate(128, (uint64_t)isr128, 0x08, 0x8E);
    setGate(255, (uint64_t)isr255, 0x08, 0x8E);
