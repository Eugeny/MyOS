...
#include "diskio.h"		/* FatFs configuration options */
...
FRESULT f_opendir (FDIR* dj, const TCHAR* path);						/* Open an existing directory */
FRESULT f_readdir (FDIR* dj, FILINFO* fno);							/* Read a directory item */
